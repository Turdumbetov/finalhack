...
const UslugPage = () => {
  ...
  return (
    <div className="container">
      ...
      <div
        id={activeTab}
        className={`tab-content ${activeTab === "specialists" ? "active" : ""}`}
      >
      ...
      <div
        id={activeTab}
        className={`tab-content ${activeTab === "diagnostics" ? "active" : ""}`}
      >
        {filteredServices.map((service, index) => (
          <div className="service" key={index}>
            <img src={service.img} alt={service.title} />
      ...
      <div
        id={activeTab}
        className={`tab-content ${activeTab === "procedures" ? "active" : ""}`}
      >
        {filteredServices.map((service, index) => (
          <div className="service" key={index}>
            <img src={service.img} alt={service.title} />
      ...
      <div
        id={activeTab}
        className={`tab-content ${activeTab === "prevention" ? "active" : ""}`}
      >
        {filteredServices.map((service, index) => (
          <div className="service" key={index}>
            <img src={service.img} alt={service.title} />
